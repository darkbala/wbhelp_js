(window.t_forms__lang = (
  ...
  t_onReady(function () {
    var t,
      ...
      r =
        (r &&
          ((o = r.getAttribute("data-tilda-project-lang")) &&
            (window.t_forms__lang = o),
          (o = r.getAttribute("data-tilda-root-zone")) &&
            (window.tildaForm.endpoint = "forms.tildaapi." + o)),
        t_forms__initForms(),
      ...
      r =
        ((r || o || n) &&
          ((t = "tilda-forms-payments-1.0"),
          document.head.querySelector('script[src*="' + t + '"]') ||
            (((e = document.createElement("script")).type = "text/javascript"),
            (e.src = "https://static.tildacdn.com/js/" + t + ".min.js"),
            (e.onerror = function () {
  ...
  (window.tildaForm.validate = function (t) {
    for (
      var e,
        r,
        o = (t = t instanceof Element ? t : t[0]).querySelectorAll(
          ".js-tilda-rule"
        ),
        n = [],
        a = !0,
      ...
      var s = o[i],
        ...
        l = l && "true" === l.getAttribute("data-hidden-by-condition");
      if (!l) {
        var l = !!parseInt(s.getAttribute("data-tilda-req") || 0, 10),
          c = s.getAttribute("data-tilda-rule") || "none",
          d = "",
          u = "",
          ...
          switch (c) {
            case "email":
              (d =
                ...
                _.length && !_.match(d) && f.type.push("email");
              break;
            case "url":
              (d =
            ...
            case "number":
              (d = /^[0-9]+$/gi),
                0 < w.length && !w.match(d) && f.type.push("number");
              break;
            case "date":
              0 < w.length &&
                !w.match(
            ...
            case "time":
              (d = /^[0-9]{2}[:\.][0-9]{2}$/gi),
                0 < w.length && !w.match(d) && f.type.push("time");
              break;
            case "name":
              (d =
                ...
                _.length && !_.match(d) && f.type.push("name");
              break;
            case "nameeng":
              (d = /^([A-Za-z\s]{1,}((\-)?[A-Za-z\.\s](\')?){0,})*$/i),
                _.length && !_.match(d) && f.type.push("nameeng");
              break;
            case "namerus":
              (d = /^([А-Яа-яЁё\s]{1,}((\-)?[А-Яа-яЁё\.\s](\')?){0,})*$/i),
                _.length && !_.match(d) && f.type.push("namerus");
              break;
            case "string":
              (d =
                ...
                _.length && !_.match(d) && f.type.push("string");
              break;
            case "chosevalue":
        ...
        f.type && f.type.length && (n[n.length] = f);
      }
    }
    return (
      "y" === g &&
  ...
  (window.tildaForm.showErrorInPopup = function (t, e) {
    ...
    var r,
      o = t.getAttribute("id"),
      n = (n = t.getAttribute("data-inputbox")) || ".blockinput",
      a = "",
      i = !1,
      s = "",
      l = "",
      c = "",
      d = document.getElementById("tilda-popup-for-error");
    d ||
    ...
    for (var u, m, p = 0; p < e.length; p++)
      if (e[p] && e[p].obj) {
        ...
        var f = e[p].obj;
        (a = (f = f instanceof Element ? f : f[0]) ? f.closest(n) : a) &&
          ((s = a.querySelectorAll(".t-input-error")),
        ...
        for (var _ = 0; _ < e[p].type.length; _++) {
          ...
          (r = t.querySelector(".js-rule-error-" + w))
            ? (r.textContent && r.innerText) || !y || -1 !== c.indexOf(y)
              ? ((l = r.textContent || r.innerText),
                -1 === c.indexOf(l) &&
                  (c = c + '<p class="t-form__errorbox-item">' + l + "</p>"))
    ...
    return (
      c &&
        ((d.querySelector(".t-form__errorbox-text").innerHTML = c),
        (m = d.querySelectorAll(".t-form__errorbox-item")),
        Array.prototype.forEach.call(m, function (t) {
          t.style.display = "block";
        }),
        document.querySelector('.t1093 [data-elem-type="form"]') &&
          ((m = window.tPopupObj && window.tPopupObj.openPopUpList) && m.length
            ? ((m = m[m.length - 1]),
              1e4 <
                (m = (m = document.querySelector(
                  '.t1093 .t-popup[data-tooltip-hook="' + m + '"]'
                ))
                  ? getComputedStyle(m).zIndex
                  : 0) && (d.style.zIndex = m + 1))
            : (d.style.zIndex = "")),
        t_fadeIn(d)),
      window.t_forms__errorTimerID &&
        window.clearTimeout(window.t_forms__errorTimerID),
  ...
  (window.tildaForm.showErrors = function (t, e) {
    ...
    for (
      ...
      if (e[c] && e[c].obj) {
        if (0 === c && "none" === e[c].obj) {
          for (
            var a = t.querySelectorAll(".js-rule-error-all"), d = 0;
            d < a.length;
            d++
          ) {
            (a[d].innerHTML =
            ...
            var u = t.querySelectorAll(".t-input")[0];
            u && t_forms__moveToErrorInput(u.getAttribute("id"), a[0]);
          }
          break;
        }
        var m = e[c].obj;
        (o = (m = m instanceof Element ? m : m[0]) ? m.closest(r) : o) &&
          ((i = o.querySelectorAll(".t-input-error")),
          t_addClass(o, "js-error-control-box"),
          0 < i.length && (n = !0));
        for (d = 0; d < e[c].type.length; d++) {
          var p = e[c].type[d],
            f = e[c].obj.id,
            s = "";
          if ((a = t.querySelectorAll(".js-rule-error-" + p)).length)
            for (var _ = 0; _ < a.length; _++)
              (w = a[_]).getAttribute("data-rule-filled")
                ? (w.style.display = "block")
                : ((w.textContent && w.innerText) || !t_forms__getMsg(p)
                    ? (s = a[0].textContent || a[0].innerText)
                    : (w.innerHTML =
                        '<a href="#" class="t-form__errorbox-link">' +
                        t_forms__getMsg(p) +
                        "</a>"),
                  (w.style.display = "block"),
                  -1 === l.indexOf(p) && t_forms__moveToErrorInput(f, w),
                  l.push(p));
          else if (
            t_forms__getMsg(p) &&
            (a = t.querySelectorAll(".js-rule-error-all")).length
          )
            for (var w, _ = 0; _ < a.length; _++)
              ((w = a[_]).innerHTML =
                '<a href="#" class="t-form__errorbox-link">' +
                t_forms__getMsg(p) +
                "</a>"),
                ...
                l.push(p);
          n &&
            (!s && t_forms__getMsg(p + "field")
              ? (s = t_forms__getMsg(p + "field"))
              : !s && t_forms__getMsg(p) && (s = t_forms__getMsg(p)),
            s &&
              o &&
              ((i = o.querySelectorAll(".t-input-error")),
              Array.prototype.forEach.call(i, function (t) {
    ...
    var y = t.querySelectorAll(".js-errorbox-all");
    return (
  ...
  (window.tildaForm.successEnd = function (form, successUrl, successCallback) {
    ...
    var successBox = form.querySelector(".js-successbox"),
      ...
      upwidgetRemoveBtns =
        (successBox &&
          ((dataSuccessMessage = successBox.getAttribute(
  ...
  (window.tildaForm.clearTCart = function (t) {
    if (
      "y" ===
      (t = t instanceof Element ? t : t[0]).getAttribute("data-formcart")
    ) {
      if (
        ((window.clearTCart = !0),
  ...
  (window.tildaForm.send = function (form, btnSubmit, formType, formKey) {
    ...
    if (
      ...
      var startRequest = Date.now(),
        xhr =
          (t_triggerEvent(form, "tildaform:beforesend"), new XMLHttpRequest());
      return (
            ...
            if (200 <= xhr.status && xhr.status < 400) {
              ...
              var tsDelta = Date.now() - startRequest,
                msgContainers =
                  ...
                  (btnSubmit.tildaSendingStatus = "0"),
                  t_forms__getErrorContainers(form, "")),
                errorBoxes = msgContainers.errorBoxes,
                allError = msgContainers.allError;
    ...
    return "y" === form.getAttribute("data-is-formajax")
      ? ((dataForm = {}),
        (dataForm = t_serializeArray(form)),
        window.tildaForm.tildapayment &&
          window.tildaForm.tildapayment.amount &&
        ...
        (xhr.onreadystatechange = function () {
          if (4 === xhr.readyState)
            if (200 <= xhr.status && xhr.status < 400) {
              ...
              var t = "/tilda/" + formId + "/submitted/",
                n = "Send data from form " + formId;
              window.Tilda &&
              "function" == typeof window.Tilda.sendEventToStatistics
                ? window.Tilda.sendEventToStatistics(t, n, "", 0)
                : "undefined" != typeof ga && "tilda" !== window.mainTracker
                ? ga("send", { hitType: "pageview", page: t, title: n })
                : "" < window.mainMetrika &&
                  window[window.mainMetrika] &&
...
function t_forms__removePlaceholder(t) {
  ...
  "INPUT" === t.tagName &&
    ((o = t.closest("[data-input-lid]")),
    (e = t.getAttribute("placeholder")),
    (r = ""),
    o
      ? (r = o.getAttribute("data-input-lid"))
      : (o = t.closest("form")) && (r = o.getAttribute("data-input-lid")),
    e &&
      r &&
      ((window.t_forms__inputData[r] = e), t.setAttribute("placeholder", "")));
}
function t_forms__moveToErrorInput(e, t) {
  function r(t) {
    t.preventDefault(), document.getElementById(e).focus();
  }
  t && (t.removeEventListener("click", r), t.addEventListener("click", r));
}
function t_forms__addPlaceholder(t) {
  var t = (t = t || window.event).target || t.srcElement,
    e = t.closest("[data-input-lid]"),
    r = "",
    e =
      (e
        ? (r = e.getAttribute("data-input-lid"))
        : (e = t.closest("form")) && (r = e.getAttribute("data-input-lid")),
      window.t_forms__inputData[r] || "");
  e &&
    r &&
    (t.setAttribute("placeholder", e), (window.t_forms__inputData[r] = ""));
}
...
function t_forms__calculateInputsWidth(t) {
  ...
  var o,
    ...
    a,
    e,
    r = document.querySelector("#rec" + t);
  !(r =
    t ||
    (!document.body.classList.contains("t706__body_cartwinshowed") &&
      ...
      ? r
      : document.querySelector(".t706")) ||
    ((o = r.querySelector(".t-form__inputsbox")) &&
      ((e = r.querySelectorAll(
        ".t-input-group_widthdef, .t-input-group_inrow"
      )),
      0 !==
        (e = o.classList.contains("t-form__inputsbox_inrow")
          ? e
          : r.querySelectorAll(".t-input-block_width")).length &&
        ...
        Array.prototype.forEach.call(e, function (t) {
          if (
            (t = o.classList.contains("t-form__inputsbox_inrow")
              ? t
              : t.closest(".t-input-group")) &&
        ...
        0 <
          ...
          )).length && t_forms__moveFieldToNextRow(e),
        (e = r.querySelectorAll(
          ".t-input-group_widthdef.t-input-group_inrow-last"
        )),
        o.classList.contains("t-form__inputsbox_inrow") &&
          0 < e.length &&
          t_forms__combineFieldsWithDefWidth(e, t))));
}
      ...
      r ||
        (e = t.reduce(function (t, e) {
          var e = e.classList.value.split(" ").filter(function (t) {
            ...
            r = 2;
          return (
            -1 !== (e = e[0]).indexOf("100") && (r = 3),
            t + Number(e.substr(e.length - 2, r))
          );
        }, 0)) <= 100 ||
        t.forEach(function (t) {
          t.classList.contains("t-input-group_inrow-last") &&
            ((t.style.marginRight = "calc(100% - (" + (e - 100) + "%)"),
      ...
      t.forEach(function (t) {
        t.classList.add(e),
          t.classList.contains("t-input-group_rg") &&
            ((t = t.getAttribute("data-input-lid")), t_input_range_init(r, t));
      });
    });
}
...
function t_forms__calculateFieldsWidthInJS(t, e) {
  ...
  for (r in n)
    t.classList.contains(n[r]) &&
      ((t.style.width = (e - 15 * (r - 1)) / r + "px"),
      (o = t.previousElementSibling) &&
        o.classList.contains("t-input-title") &&
        (o.style.width = (e - 15 * (r - 1)) / r + "px"),
      window.innerWidth < 480 &&
        (t && (t.style.width = "100%"), o && (o.style.width = "100%")));
}
...
function t_forms__initBtnClick(t) {
  var e = (t = t || window.event).target || t.srcElement,
    e = !!e.closest('[type="submit"]') && e;
  if (e) {
    var r = e.closest(".js-form-proccess");
    if (r) {
      t.preventDefault ? t.preventDefault() : (t.returnValue = !1);
      var o,
        n,
        ...
        t = r.getAttribute("id"),
        i = "";
      if (!((i = e.tildaSendingStatus ? e.tildaSendingStatus : i) && 1 <= i))
        if (!t_hasClass(e, "t706__submit_disable"))
          return (
            t_addClass(e, "t-btn_sending"),
            (e.tildaSendingStatus = "1"),
            window.tildaForm.hideErrors(r),
            (i = window.tildaForm.validate(r)),
            window.tildaForm.showErrors(r, i)
              ? (t_removeClass(e, "t-btn_sending"),
                void (e.tildaSendingStatus = "0"))
              : ((i = document
                  .getElementById("allrecords")
                  .getAttribute("data-tilda-formskey")),
                (o = parseInt(r.getAttribute("data-formactiontype"))),
                r.querySelectorAll(".js-formaction-services").length ||
                1 === o ||
                i
                  ? r.querySelector(".g-recaptcha") && grecaptcha
                    ? ((window.tildaForm.currentFormProccessing = {
                        form: r,
                        btn: e,
                        formtype: o,
                      ...
                      (a = r.tildaCaptchaClientId)
                        ? grecaptcha.reset(a)
                        : ((n = {
                            size: "invisible",
                            sitekey: r.getAttribute("data-tilda-captchakey"),
                            callback: window.tildaForm.captchaCallback,
                          }),
                          (a = grecaptcha.render(t + "recaptcha", n)),
                          (r.tildaCaptchaClientId = a)),
                      void grecaptcha.execute(a))
                    : void window.tildaForm.send(r, e, o, i)
                  : ((n = (t = t_forms__getErrorContainers(r, "")).errorBoxes),
                    (a = t.allError),
                    Array.prototype.forEach.call(a, function (t) {
                    ...
                    t_addClass(r, "js-send-form-error"),
                    t_removeClass(e, "t-btn_sending"),
                    (e.tildaSendingStatus = "0"),
                    void t_triggerEvent(r, "tildaform:aftererror")))
          );
    }
  }
}
...
function t_forms__submitEvent(t) {
  var e,
    r = t;
  (r = t.target ? t.target : r) &&
    ((e = ""),
    (e =
      (r = r.querySelector('[type="submit"]')) && r.tildaSendingStatus
...
function t_forms__addRecaptcha() {
  ...
  Array.prototype.forEach.call(t, function (t) {
    var e,
      r,
      o,
      n = t.getAttribute("data-tilda-captchakey");
    n
      ? ((e = t.getAttribute("id")),
...
function t_forms__getMsg(t) {
  ...
  return (
    ...
    ((e =
      "function" == typeof t_forms__getDict && "RU" !== r && "EN" !== r
        ? t_forms__getDict()
        : e)[r] || e.EN)[t]
  );
}
function checkVerifyTildaCaptcha(t) {
  if (
    ...
    e &&
      ((e.value = t),
      r && t_removeEl(r),
      (t = e.closest("form")) && t_forms__submitEvent(t));
  }
}
function t_parseScripts(a, t) {
  t = a.querySelectorAll(t + "script");
  Array.prototype.forEach.call(t, function (t) {
    for (
...
function t_forms__onSuccess(t) {
  var e = (t = t instanceof Element ? t : t[0]).closest(".r"),
    r = e.getAttribute("data-record-type"),
    o = t.querySelector(".t-form__inputsbox"),
    n = getComputedStyle(o, null),
    a = parseInt(n.paddingTop) || 0,
    n = parseInt(n.paddingBottom) || 0,
    a =
      o.clientHeight -
      (a + n) +
    ...
    d =
      (121 != r ||
        ((c = t.getAttribute("data-success-callback")) &&
          (r = c.split("_onSuccess")[0].replace("t", ""))),
      "t" + r + "__inputsbox_hidden"),
    u = [702, 708, 862, 945, 1014],
    m = !0,
    i = 960 < window.innerWidth ? n - 200 : n - 100,
    p = document.querySelector(".t-tildalabel");
  if (n > window.scrollY || l - a < s - 100)
    o.classList.add(d),
      l < s &&
        p &&
        setTimeout(function () {
  ...
  _ &&
    ...
    (835 != r && 862 != r) ||
      ((c = e.querySelector(".t" + r + "__btn_prev")),
      (n = e.querySelector(".t" + r + "__wrapper")),
      (a = e.querySelector(".t" + r + "__quiz-form-wrapper")),
...
Array.prototype.some ||
  ...
  Array.prototype.indexOf ||
    (Array.prototype.indexOf = function (t, e) {
      ...
      e |= 0;
      if (n <= e) return -1;
      for (r = Math.max(0 <= e ? e : n - Math.abs(e), 0); r < n; r++)
...
function t_serializeArray(t) {
  for (
    ...
    var n = r[o].closest(".t-input-group");
    if (
      !(
        !r[o].name ||
        r[o].disabled ||
        -1 < ["file", "reset", "submit", "button"].indexOf(r[o].type) ||
        (n && n.getAttribute("data-hidden-by-condition"))
      )
    )
      if ("select-multiple" === r[o].type)
        for (var a = r[o].options, i = 0; i < a.length; i++)
          a[i].selected && e.push({ name: a[i].name, value: a[i].value });
      else
